...
{
    public class A1PatientController : Controller
    {
        private readonly PatientsContext _context;

        public A1PatientController(PatientsContext context)
        {
            _context = context;
        }
